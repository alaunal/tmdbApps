...
import { Heading, Text, Divider, Box, IconButton } from "native-base";
    ...
    <Layout>
      <ScrollView
        ...
        <Box mb={4} px={3} pt={3}>
          ...
          <Text style={{ color: theme.color }} fontSize="lg">
            a just simple mobile application movie build with react-native CLI,
            redux & TMDB APIs
          </Text>
        </Box>
        ...
        <CardMovie grid={gridType} data={movies} isLoading={loading} onPress={moveToDetail} />
      </ScrollView>
    </Layout>
  );
};
